<template>
  <div class="article-admin">
    <b-form>
      ...
      <b-form-group label="Categoria:" label-for="article-categoryId" v-if="!isExclusao">
        <b-form-select id="article-categoryId" :options="categories" v-model="article.categoryId"></b-form-select>
      </b-form-group>
      <b-form-group label="Autor:" label-for="article-userId" v-if="!isExclusao">
        <b-form-select id="article-userId" :options="users" v-model="article.userId"></b-form-select>
      </b-form-group>
      <b-form-group label="Conteúdo" label-for="article-content" v-if="!isExclusao">
